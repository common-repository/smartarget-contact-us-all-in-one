 ...
 */
class SmartargetContactUs_Admin {
	...
	public function add_plugin_admin_menu() {
		...
		*/
		add_options_page( 'Smartarget Contact Us - All in one Settings', 'Smartarget Contact Us - All in one', 'manage_options', $this -> plugin_name, array($this, 'display_plugin_setup_page'));
	}
	...
	public function display_plugin_setup_page() {
		...
		include_once( 'partials/smartarget-contact-us-admin-display.php' );
	}
